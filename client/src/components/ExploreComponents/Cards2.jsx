...
import gamedocscard1 from '../../../images/gamedocscard1.png'
...
const Cards2 = () => {
  ...
  return (
        ...
        <div className="md:flex justify-center mx-6 md:mb-24">
            ...
            <div className="cursor-pointer rounded-lg shadow-lg bg-gradient-to-r from-rose-400 to-indigo-700 bg-gradient-to-r from-amber-500 to-indigo-600  max-w-fit md:max-w-xs hover:scale-105 active:scale-100S my-4 mx-4 hover:transition-all duration-500 ease-in-out hover:drop-shadow-2xl">
            ...
            <img className="rounded-t-lg" src={gamedocscard1} alt="" />  
                <div className="p-6">
                    <h5 className="text-white text-xl font-semibold mb-2">
                        Game Docs
                    </h5>
